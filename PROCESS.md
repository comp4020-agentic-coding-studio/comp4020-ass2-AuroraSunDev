...
That fallback was defensible without an API, but not once one existed. After connecting it, I rejected the SVG because "the SVG rig read as a generic outline diagram, not as a specimen under test" ([`1aa2ef1`](https://github.com/comp4020-agentic-coding-studio/comp4020-ass2-AuroraSunDev/commit/1aa2ef1)). I replaced it with generated photographs and later a reusable pipeline ([`736694e`](https://github.com/comp4020-agentic-coding-studio/comp4020-ass2-AuroraSunDev/commit/736694e)) — the difference is easier to see than to describe:

![The homepage hero as a flat SVG line drawing of a compression rig holding a plain outlined sandwich](docs/hero-svg-fallback.png)

![The same hero after the fix: a photograph of a real sandwich compressed between the steel plates of a benchtop press](docs/hero-generated-photo.png)
